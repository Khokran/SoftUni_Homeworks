...
namespace FightingArena
{
    public class Arena
    {
        ...
        {
            return this.gladiators.OrderByDescending(g => g.GetStatPower()).First();
        }
        public Gladiator GetGladitorWithHighestWeaponPower()
        {
            return this.gladiators.OrderByDescending(g => g.GetWeaponPower()).First();
        }
        public Gladiator GetGladitorWithHighestTotalPower()
        {
            return this.gladiators.OrderByDescending(g => g.GetTotalPower()).First();
        }
