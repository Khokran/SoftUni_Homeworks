        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                try
                {
                    ...
                    Console.WriteLine("Database create successfully!");
                }
                catch (Exception e)
                {
                    Console.WriteLine("There was a error sreating database!");
            ...
            using (connection)
            {
                ...
                {
                    Console.WriteLine("There was a error processing your request!");
                    Console.WriteLine($"{e.Message}");
                }
            }
        }
